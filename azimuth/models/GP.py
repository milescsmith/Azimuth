...
def gp_on_fold(feature_sets, train, test, y, y_all, learn_options):
    ...
    if 'drug' in feature_sets:
        ...
        kern += Linear(Q, active_dims=range(current_dim, current_dim+Q), name='drug_lin')
    ...
    if 'gene effect' in feature_sets:
        ...
        kern += Linear(Q, active_dims=range(current_dim, current_dim+Q), name='gene_lin')
    ...
    if "Percent Peptide" in feature_sets:
        ...
        kern += RBF(Q, active_dims=range(current_dim, current_dim+Q), name='percent_pept')
    ...
    if "Nucleotide cut position" in feature_sets:
        ...
        kern += RBF(Q, active_dims=range(current_dim, current_dim+Q), name='nucleo_cut')
    ...
    if "Strand effect" in feature_sets:
        ...
        kern += Linear(Q, active_dims=range(current_dim, current_dim+Q), name='strand')
    ...
    if "TM" in feature_sets:
        ...
        kern += RBF(Q, ARD=True, active_dims=range(current_dim, current_dim+Q), name='TM')
    ...
    if "gene features" in feature_sets:
        ...
        kern += Linear(Q, ARD=True, active_dims=range(current_dim, current_dim+Q), name='genefeat')
