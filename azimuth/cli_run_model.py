...
if __name__ == '__main__':
    ...
    parser.add_argument('--likelihood',
                        ...
                        default='gaussian')
    # applies only to GP:
    parser.add_argument('--weighted-degree',
                        dest='WD',
                        action='store',
                        type=int,
                        default=3)

    parser.add_argument('--adaboost-learning-rate',
                        dest='adaboost_lr',
                        action='store',
                        type=float,
                        default=0.1)
    parser.add_argument('--adaboost-max-depth',
                        dest='adaboost_max_depth',
                        action='store',
                        type=int,
                        default=3)
    parser.add_argument('--adaboost-num-estimators',
                        dest='adaboost_num_estimators',
                        action='store',
                        type=int,
                        default=100)
    parser.add_argument('--adaboost-CV',
                        dest='adaboost_CV',
                        action='store_true',
                        default=False)
    ...
    results, all_learn_options = run_models([options.model],
